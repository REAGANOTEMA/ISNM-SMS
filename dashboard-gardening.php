...
<head>
    ...
    <title>Gardening Department Dashboard - ISNM</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .plant-item { display: flex; align-items: center; gap: 1rem; padding: 1rem 0; border-bottom: 1px solid var(--gray-100); }
        .plant-item:last-child { border-bottom: none; }
        .plant-icon { width: 40px; height: 40px; border-radius: 50%; background: var(--gray-200); display: flex; align-items: center; justify-content: center; color: var(--gray-600); }
        .plant-info { flex: 1; }
        .plant-name { font-weight: 500; margin-bottom: 0.25rem; }
        .plant-location { font-size: 0.875rem; color: var(--gray-600); }
        .plant-status { padding: 0.25rem 0.75rem; border-radius: 12px; font-size: 0.75rem; font-weight: 500; }
        .status-healthy { background: rgba(16, 185, 129, 0.1); color: var(--success); }
        .status-needs-care { background: rgba(245, 158, 11, 0.1); color: var(--warning); }
    ...
    <div class="dashboard">
        <aside class="sidebar">
            <div class="sidebar-header">
                <div class="user-info">
                    <div class="user-avatar"><i class="fas fa-leaf"></i></div>
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-seedling"></i> Plant Management</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-tasks"></i> Work Schedule</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-toolbox"></i> Equipment</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-tint"></i> Irrigation</a></li>
        ...
        <main class="main-content">
            <div class="header">
                <h1>Gardening Department Dashboard</h1>
                <p>Welcome back, <?php echo htmlspecialchars($user['username']); ?>. Manage campus landscaping and plant care.</p>
            </div>
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-icon green"><i class="fas fa-leaf"></i></div>
                    <div class="stat-value">156</div>
                    <div class="stat-label">Plants Maintained</div>
                </div>
                <div class="stat-card">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Irrigation Zones</div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon red"><i class="fas fa-exclamation-triangle"></i></div>
                    <div class="stat-value">3</div>
                    <div class="stat-label">Plants Need Care</div>
                </div>
            </div>
            <div class="content-grid">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">Today's Gardening Tasks</h2>
                        <a href="#" class="btn btn-secondary">View All</a>
                    </div>
                    <ul class="task-list">
                        <li class="task-item">
                            <div class="task-name">Lawn Mowing</div>
                            <div class="task-location">Front Lawn Area</div>
                            <div class="task-meta">Scheduled: 8:00 AM - 10:00 AM - In Progress</div>
                        </li>
                        <li class="task-item">
                            <div class="task-name">Plant Pruning</div>
                            <div class="task-location">Garden Beds A & B</div>
                            <div class="task-meta">Scheduled: 10:30 AM - 12:00 PM - Pending</div>
                        </li>
                        <li class="task-item">
                            <div class="task-name">Fertilizer Application</div>
                            <div class="task-location">Vegetable Garden</div>
                            <div class="task-meta">Scheduled: 2:00 PM - 3:30 PM - Pending</div>
                        </li>
                    </ul>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">Plant Health Monitor</h2>
                        <a href="#" class="btn btn-secondary">All Plants</a>
                    </div>
                    <ul class="plant-list">
                        <li class="plant-item">
                            <div class="plant-icon"><i class="fas fa-tree"></i></div>
                            <div class="plant-info">
                                <div class="plant-name">Royal Palm Trees</div>
                                <div class="plant-location">Main Entrance</div>
                            </div>
                            <div class="plant-status status-healthy">Healthy</div>
                        </li>
                        <li class="plant-item">
                            <div class="plant-icon"><i class="fas fa-leaf"></i></div>
                            <div class="plant-info">
                                <div class="plant-name">Rose Garden</div>
                                <div class="plant-location">Central Garden</div>
                            </div>
                            <div class="plant-status status-needs-care">Needs Care</div>
                        </li>
                        <li class="plant-item">
                            <div class="plant-icon"><i class="fas fa-seedling"></i></div>
                            <div class="plant-info">
                                <div class="plant-name">Vegetable Seedlings</div>
                                <div class="plant-location">Back Garden</div>
                            </div>
                            <div class="plant-status status-critical">Critical</div>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Gardening Operations</h2>
                </div>
                <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                    <a href="#" class="btn btn-primary"><i class="fas fa-plus"></i> Add Task</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-seedling"></i> Plant Registry</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-tint"></i> Irrigation Control</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-toolbox"></i> Equipment Check</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-chart-bar"></i> Growth Reports</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-calendar"></i> Schedule Work</a>
                </div>
            </div>
        </main>
    </div>
