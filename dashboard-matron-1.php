...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'staff' || $_SESSION['department'] !== 'matron-1') {
...
$matron_info = [];
try {
    $stmt = $pdo->prepare("SELECT * FROM users WHERE id = ? AND role = 'staff' AND department = 'matron-1'");
...
try {
    ...
    // Girls in dormitory 1
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM student_dormitories WHERE dormitory = 'Dormitory 1' AND gender = 'female'");
...
<head>
    ...
    <title>Matron 1 Dashboard - ISNM</title>
...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-links">
                <a href="dashboard-matron-1.php" class="nav-link">
                ...
                <div class="user-menu">
                    ...
                    <span><?php echo htmlspecialchars($matron_info['username'] ?? 'Matron 1'); ?></span>
    ...
    <main class="main-container">
        <header class="dashboard-header fade-in">
            <div class="header-content">
                <h1 class="header-title">MATRON 1</h1>
        ...
        <div class="stats-grid fade-in">
            ...
            <div class="stat-card">
                ...
                <div class="stat-label">Girls in Dormitory 1</div>
            </div>
