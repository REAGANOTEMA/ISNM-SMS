...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'staff' || $_SESSION['department'] !== 'hod-nursing') {
...
$hod_info = [];
try {
    $stmt = $pdo->prepare("SELECT * FROM users WHERE id = ? AND role = 'staff' AND department = 'hod-nursing'");
...
try {
    ...
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM users WHERE role = 'student' AND department = 'nursing'");
    $nursing_stats['total_students'] = $stmt->fetchColumn();
    
    // Nursing courses
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM courses WHERE department = 'nursing'");
    $nursing_stats['total_courses'] = $stmt->fetchColumn();
    
    // Nursing staff
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM users WHERE role = 'staff' AND department = 'nursing'");
    $nursing_stats['total_staff'] = $stmt->fetchColumn();
    
    // Active clinical instructors
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM users WHERE role = 'clinical-instructor' AND department = 'nursing'");
    $nursing_stats['clinical_instructors'] = $stmt->fetchColumn();
    
    // Pending assessments
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM student_assessments WHERE department = 'nursing' AND status = 'pending'");
    $nursing_stats['pending_assessments'] = $stmt->fetchColumn();
    
    // Clinical placements this month
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM clinical_placements WHERE department = 'nursing' AND MONTH(start_date) = MONTH(CURRENT_DATE())");
    $nursing_stats['clinical_placements_month'] = $stmt->fetchColumn();
    
    // Department budget utilization
    $stmt = $pdo->query("SELECT SUM(amount) as total FROM department_expenses WHERE department = 'nursing' AND MONTH(expense_date) = MONTH(CURRENT_DATE())");
    $nursing_stats['budget_utilization'] = $stmt->fetchColumn() ?? 0;
} catch (PDOException $e) {
    error_log("Error fetching Nursing Department statistics: " . $e->getMessage());
}
...
try {
    $stmt = $pdo->query("
        ...
        WHERE sa.department = 'nursing' AND sa.status = 'pending'
...
try {
    $stmt = $pdo->query("
        ...
        WHERE cp.department = 'nursing' AND cp.start_date >= CURDATE()
...
<head>
    ...
    <title>Head of Department (Nursing) Dashboard - ISNM</title>
...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-links">
                <a href="dashboard-hod-nursing.php" class="nav-link">
                ...
                <a href="#" class="nav-link">
                    <i class="fas fa-heartbeat"></i> Clinical Placements
                </a>
                <a href="#" class="nav-link">
                ...
                <div class="user-menu">
                    ...
                    <span><?php echo htmlspecialchars($hod_info['username'] ?? 'HOD Nursing'); ?></span>
    ...
    <main class="main-container">
        <header class="dashboard-header fade-in">
            <div class="header-content">
                <h1 class="header-title">HEAD OF DEPARTMENT (NURSING)</h1>
                <p class="header-subtitle">Nursing Department Leadership & Academic Excellence</p>
            </div>
        </header>
        ...
        <div class="stats-grid fade-in">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo number_format($nursing_stats['total_students'] ?? 0); ?></div>
                <div class="stat-label">Total Nursing Students</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo number_format($nursing_stats['total_courses'] ?? 0); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo number_format($nursing_stats['total_staff'] ?? 0); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo number_format($nursing_stats['clinical_instructors'] ?? 0); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo number_format($nursing_stats['pending_assessments'] ?? 0); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo number_format($nursing_stats['clinical_placements_month'] ?? 0); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo number_format($nursing_stats['budget_utilization'] ?? 0); ?></div>
        ...
        <div class="content-grid fade-in">
            ...
            <div class="panel">
                <div class="panel-header">
                    <h2 class="panel-title">
                        <i class="fas fa-hospital"></i> Upcoming Clinical Placements
                    </h2>
                    <a href="#" class="nav-link">View All</a>
                </div>
                <div class="assessment-list">
                    <?php foreach ($upcoming_placements as $placement): ?>
                        <div class="assessment-item">
                            ...
                            <div class="assessment-content">
                                ...
                                <div class="assessment-time">
                                    Department: <?php echo htmlspecialchars($placement['department'] ?? 'Nursing'); ?>
                                </div>
                            </div>
