...
<head>
    ...
    <title>Cleaning Department Dashboard - ISNM</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .task-item { background: var(--gray-50); border-radius: 8px; padding: 1rem; margin-bottom: 1rem; border-left: 4px solid var(--primary); }
        .task-name { font-weight: 600; color: var(--primary); margin-bottom: 0.25rem; }
        .task-location { font-weight: 500; margin-bottom: 0.25rem; }
        .task-meta { font-size: 0.875rem; color: var(--gray-600); }
        .area-list { list-style: none; }
        .area-item { display: flex; align-items: center; gap: 1rem; padding: 1rem 0; border-bottom: 1px solid var(--gray-100); }
        .area-item:last-child { border-bottom: none; }
        .area-icon { width: 40px; height: 40px; border-radius: 50%; background: var(--gray-200); display: flex; align-items: center; justify-content: center; color: var(--gray-600); }
        .area-info { flex: 1; }
        .area-name { font-weight: 500; margin-bottom: 0.25rem; }
        .area-status { font-size: 0.875rem; color: var(--gray-600); }
        .area-badge { padding: 0.25rem 0.75rem; border-radius: 12px; font-size: 0.75rem; font-weight: 500; }
        .status-clean { background: rgba(16, 185, 129, 0.1); color: var(--success); }
        .status-pending { background: rgba(245, 158, 11, 0.1); color: var(--warning); }
        .status-dirty { background: rgba(239, 68, 68, 0.1); color: var(--danger); }
    ...
    <div class="dashboard">
        <aside class="sidebar">
            <div class="sidebar-header">
                <div class="user-info">
                    <div class="user-avatar"><i class="fas fa-broom"></i></div>
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-tasks"></i> Cleaning Schedule</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-map-marked-alt"></i> Area Management</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-users"></i> Staff Assignment</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-soap"></i> Supplies</a></li>
        ...
        <main class="main-content">
            <div class="header">
                <h1>Cleaning Department Dashboard</h1>
                <p>Welcome back, <?php echo htmlspecialchars($user['username']); ?>. Manage campus cleaning operations.</p>
            </div>
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-icon orange"><i class="fas fa-broom"></i></div>
                    <div class="stat-value">24</div>
                    <div class="stat-label">Areas Cleaned Today</div>
                </div>
                <div class="stat-card">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Urgent Cleanups</div>
                </div>
            </div>
            <div class="content-grid">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">Today's Cleaning Schedule</h2>
                        <a href="#" class="btn btn-secondary">View All</a>
                    </div>
                    <ul class="task-list">
                        <li class="task-item">
                            <div class="task-name">Classroom Block A</div>
                            <div class="task-location">All Floors - 12 Rooms</div>
                            <div class="task-meta">Scheduled: 6:00 AM - 8:00 AM - Completed</div>
                        </li>
                        <li class="task-item">
                            <div class="task-name">Laboratory Cleaning</div>
                            <div class="task-location">Science Labs - 4 Rooms</div>
                            <div class="task-meta">Scheduled: 9:00 AM - 11:00 AM - In Progress</div>
                        </li>
                        <li class="task-item">
                            <div class="task-name">Hostel Common Areas</div>
                            <div class="task-location">Dormitories A & B</div>
                            <div class="task-meta">Scheduled: 2:00 PM - 4:00 PM - Pending</div>
                        </li>
                    </ul>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">Area Status</h2>
                        <a href="#" class="btn btn-secondary">All Areas</a>
                    </div>
                    <ul class="area-list">
                        <li class="area-item">
                            <div class="area-icon"><i class="fas fa-chalkboard"></i></div>
                            <div class="area-info">
                                <div class="area-name">Classroom Block A</div>
                                <div class="area-status">Last cleaned: 2 hours ago</div>
                            </div>
                            <div class="area-badge status-clean">Clean</div>
                        </li>
                        <li class="area-item">
                            <div class="area-icon"><i class="fas fa-flask"></i></div>
                            <div class="area-info">
                                <div class="area-name">Science Laboratories</div>
                                <div class="area-status">Cleaning in progress</div>
                            </div>
                            <div class="area-badge status-pending">Pending</div>
                        </li>
                        <li class="area-item">
                            <div class="area-icon"><i class="fas fa-bed"></i></div>
                            <div class="area-info">
                                <div class="area-name">Hostel Dormitories</div>
                                <div class="area-status">Needs attention</div>
                            </div>
                            <div class="area-badge status-dirty">Dirty</div>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Cleaning Operations</h2>
                </div>
                <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                    <a href="#" class="btn btn-primary"><i class="fas fa-plus"></i> Schedule Task</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-users"></i> Assign Staff</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-soap"></i> Manage Supplies</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-clipboard-check"></i> Quality Check</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-chart-bar"></i> View Reports</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-bell"></i> Report Issue</a>
                </div>
            </div>
        </main>
    </div>
