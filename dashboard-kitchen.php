...
<head>
    ...
    <title>Kitchen Department Dashboard - ISNM</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .meal-item { background: var(--gray-50); border-radius: 8px; padding: 1rem; margin-bottom: 1rem; border-left: 4px solid var(--primary); }
        .meal-name { font-weight: 600; color: var(--primary); margin-bottom: 0.25rem; }
        .meal-time { font-weight: 500; margin-bottom: 0.25rem; }
        .meal-meta { font-size: 0.875rem; color: var(--gray-600); }
        .inventory-list { list-style: none; }
        .inventory-item { display: flex; align-items: center; gap: 1rem; padding: 1rem 0; border-bottom: 1px solid var(--gray-100); }
        .inventory-item:last-child { border-bottom: none; }
        .inventory-icon { width: 40px; height: 40px; border-radius: 50%; background: var(--gray-200); display: flex; align-items: center; justify-content: center; color: var(--gray-600); }
        .inventory-info { flex: 1; }
        .inventory-name { font-weight: 500; margin-bottom: 0.25rem; }
        .inventory-quantity { font-size: 0.875rem; color: var(--gray-600); }
        .inventory-status { padding: 0.25rem 0.75rem; border-radius: 12px; font-size: 0.75rem; font-weight: 500; }
    ...
    <div class="dashboard">
        <aside class="sidebar">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-utensils"></i> Meal Planning</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-shopping-cart"></i> Inventory</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-users"></i> Staff Management</a></li>
                    <li class="nav-item"><a href="#" class="nav-link"><i class="fas fa-clipboard-check"></i> Quality Control</a></li>
        ...
        <main class="main-content">
            <div class="header">
                ...
                <p>Welcome back, <?php echo htmlspecialchars($user['username']); ?>. Manage meal services and kitchen operations.</p>
            </div>
            ...
            <div class="content-grid">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">Today's Meal Schedule</h2>
                    ...
                    <ul class="meal-list">
                        <li class="meal-item">
                            ...
                            <div class="meal-meta">Pancakes, Eggs, Tea, Fruits - 285 students served</div>
                        </li>
                        <li class="meal-item">
                            <div class="meal-name">Lunch</div>
                            <div class="meal-time">12:00 PM - 2:00 PM</div>
                            <div class="meal-meta">Rice, Beans, Vegetables, Meat - 342 students served</div>
                        </li>
                        <li class="meal-item">
                            <div class="meal-name">Dinner</div>
                            <div class="meal-time">6:00 PM - 8:00 PM</div>
                            <div class="meal-meta">Matooke, Stew, Salad, Juice - Scheduled</div>
                        </li>
                    </ul>
                </div>
                <div class="card">
                    ...
                    <ul class="inventory-list">
                        <li class="inventory-item">
                            <div class="inventory-icon"><i class="fas fa-bread-slice"></i></div>
                            <div class="inventory-info">
                                <div class="inventory-name">Flour</div>
                                <div class="inventory-quantity">45 kg remaining</div>
                            </div>
                            <div class="inventory-status status-good">Good</div>
                        </li>
                        <li class="inventory-item">
                            <div class="inventory-icon"><i class="fas fa-egg"></i></div>
                            <div class="inventory-info">
                                <div class="inventory-name">Eggs</div>
                                <div class="inventory-quantity">8 dozen remaining</div>
                            </div>
                            <div class="inventory-status status-low">Low</div>
                        </li>
                        <li class="inventory-item">
                            <div class="inventory-icon"><i class="fas fa-carrot"></i></div>
                            <div class="inventory-info">
                                <div class="inventory-name">Vegetables</div>
                                <div class="inventory-quantity">12 kg remaining</div>
                            </div>
                            <div class="inventory-status status-critical">Critical</div>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Kitchen Operations</h2>
                </div>
                <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                    <a href="#" class="btn btn-primary"><i class="fas fa-plus"></i> Plan Menu</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-shopping-cart"></i> Order Supplies</a>
                    <a href="#" class="btn btn-primary"><i class="fas fa-users"></i> Schedule Staff</a>
                    ...
                    <a href="#" class="btn btn-primary"><i class="fas fa-bell"></i> Send Notifications</a>
                </div>
            </div>
        </main>
    </div>
