...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'staff' || $_SESSION['department'] !== 'matron-3') {
...
$matron_info = [];
try {
    $stmt = $pdo->prepare("SELECT * FROM users WHERE id = ? AND role = 'staff' AND department = 'matron-3'");
...
try {
    ...
    // Girls in dormitory 3
    $stmt = $pdo->query("SELECT COUNT(*) as total FROM student_dormitories WHERE dormitory = 'Dormitory 3' AND gender = 'female'");
...
<head>
    ...
    <title>Matron 3 Dashboard - ISNM</title>
...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-links">
                <a href="dashboard-matron-3.php" class="nav-link">
                ...
                <div class="user-menu">
                    ...
                    <span><?php echo htmlspecialchars($matron_info['username'] ?? 'Matron 3'); ?></span>
    ...
    <main class="main-container">
        <header class="dashboard-header fade-in">
            <div class="header-content">
                <h1 class="header-title">MATRON 3</h1>
        ...
        <div class="stats-grid fade-in">
            ...
            <div class="stat-card">
                ...
                <div class="stat-label">Girls in Dormitory 3</div>
            </div>
